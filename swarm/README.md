...
Building Swarm requires Go (version 1.10 or later).
    ...
    go get -d github.com/cc14514/go-ethereum

    go install github.com/cc14514/go-ethereum/cmd/swarm
...
You must have your working copy under `$GOPATH/src/github.com/cc14514/go-ethereum`.
...
```
git clone git@github.com:nirname/go-ethereum.git $GOPATH/src/github.com/cc14514/go-ethereum
```
...
```
stateth --rm --grafana-dashboards-folder $GOPATH/src/github.com/cc14514/go-ethereum/swarm/grafana_dashboards --influxdb-database metrics
```
 ...
 * [Code review guidelines](https://github.com/cc14514/go-ethereum/wiki/Code-Review-Guidelines).
