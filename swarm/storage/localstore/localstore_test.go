...
import (
	...
	ch "github.com/cc14514/go-ethereum/swarm/chunk"
...
//
// # go test -benchmem -run=none github.com/cc14514/go-ethereum/swarm/storage/localstore -bench BenchmarkNew -v -timeout 20m
// goos: darwin
// goarch: amd64
